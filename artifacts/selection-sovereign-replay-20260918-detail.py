...
stem=ROOT/"artifacts/selection-sovereign-replay-20260918-detail"
...
report={
    "validation":"current production detail OCR + one fresh production _loop_router replay",
...
with stem.with_suffix(".progress.log").open("w",encoding="utf-8") as progress:
    clock=bridge.PhaseClock("selection-detail-acceptance",stream=progress)
    try:
