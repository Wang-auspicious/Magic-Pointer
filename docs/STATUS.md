...
分支 `codex/multi-stroke-and-voice-fix`，未推送。当前全量测试：**Python 1073 项、Node 148 项（90 个 JS/TS 源文件）**，ESLint 与 TypeScript strict typecheck 通过；Electron/Node 源码现为 **59 JS / 31 TS**，重构前 Node 基线为 145 项。
