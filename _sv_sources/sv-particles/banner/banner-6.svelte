...
{#if isVisible}
	<div class="dark w-full bg-muted px-4 py-3 text-foreground md:py-2">
		<div class="flex gap-2 md:items-center">
			<div class="flex grow gap-3 md:items-center">
				<EclipseIcon aria-hidden="true" class="shrink-0 opacity-60 max-md:mt-0.5" size={16} />
				<div class="flex grow flex-col justify-between gap-3 md:flex-row md:items-center">
					...
					<div class="flex gap-2 max-md:flex-wrap">
						<Button class="text-sm" size="sm">Download</Button>
						<Button class="text-sm" size="sm" variant="outline">Learn more</Button>
					</div>
				</div>
			</div>
			<Button
