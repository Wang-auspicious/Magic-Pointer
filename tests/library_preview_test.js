...
const shell = fs.readFileSync('electron/renderer/studio_layout.css', 'utf8');
assert.doesNotMatch(shell, /\.mpw-(?:customize|new-session) span\s*[,{]/,
...
console.log('Library preview behavior ok');
